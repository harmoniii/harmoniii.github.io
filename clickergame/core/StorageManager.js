// core/StorageManager.js - Управление сохранением и загрузкой
export class StorageManager {
    ...
    save(gameState) {
      try {
        if (!gameState || typeof gameState.getSaveData !== 'function') {
          throw new Error('Invalid game state for saving');
        }
    ...
    exportToString(gameState) {
      try {
        const saveData = gameState.getSaveData();
        saveData.exportVersion = this.CURRENT_VERSION;
